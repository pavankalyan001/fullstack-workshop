package com.example.task_manager_spring.service;

import com.example.task_manager_spring.model.Task;
import com.example.task_manager_spring.model.TaskStatus;
import com.example.task_manager_spring.repository.TaskRepository;
 ...
 * JPA VERSION:
 * - No update() method
 * - Uses Hibernate dirty checking
 * - @Transactional is mandatory for updates
 */
@Service
public class TaskService {
    ...
    public Task createTask(String title, String description) {
        ...
        return taskRepository.save(task); // save = insert
    }
    ...
    public Task updateTaskStatus(Long id, TaskStatus newStatus) {
        ...
        task.setStatus(newStatus);   // Hibernate tracks this change
        return task;                 // auto-update on commit
    }
